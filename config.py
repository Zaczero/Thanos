...
if not SECRET:
    ...
    print(f'🚧 Warning: ' f'Environment variable SECRET is not set. ' f'Generated a random secret: {SECRET}')
...
if DRY_RUN:
    print('🦺 Notice: ' 'Environment variable DRY_RUN is set. ' 'No changes will be made to OpenStreetMap.')
...
CHANGESET_MAX_AGE = timedelta(days=float(os.getenv('CHANGESET_MAX_AGE', '180')))  # 6 months
